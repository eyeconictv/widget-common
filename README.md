...
The files in widget-common contain shared functionality used by Rise Vision Widgets and apps. As such, they are meant to be linked to from other applications and are not standalone components.
